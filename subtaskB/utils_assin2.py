...
class Assin2(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        # 2021.10.16注释， 使用本地目录
        data_dir = dict()
        data_dir["train"] = '/home/admin/cuixuange/SemEval_2022/TASK2/Datasets/assin2/assin2-train-only.xml'
        data_dir["test"] = '/home/admin/cuixuange/SemEval_2022/TASK2/Datasets/assin2/assin2-test.xml'
        data_dir["dev"] = '/home/admin/cuixuange/SemEval_2022/TASK2/Datasets/assin2/assin2-dev.xml'
